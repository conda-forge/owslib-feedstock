...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3179&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/owslib-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `owslib` can be installed with `conda`:
...
```
mamba install owslib
```

It is possible to list all of the versions of `owslib` available on your platform with `conda`:
...
```
mamba search owslib --channel conda-forge
```
...
mamba repoquery search owslib --channel conda-forge

# List packages depending on `owslib`:
mamba repoquery whoneeds owslib --channel conda-forge

# List dependencies of `owslib`:
mamba repoquery depends owslib --channel conda-forge
```
